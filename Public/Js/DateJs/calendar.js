Calendar = function (mondayFirst, dateStr, onSelected, onClose,format) {
	// member variables
	this.activeDiv = null;
	...
	this.minYear = 1970;
	this.maxYear = 2050;
	this.dateFormat = format || Calendar._TT["DEF_DATE_FORMAT"];
...
//	(this.weekNumbers) && ++title_length;
	...
	this._nav_py = hh("<img id=objyprev src='/Public/Js/DateJs/img/yprev.gif'>", 1, -2);
...
//	this._nav_py = hh("&#x00ab;", 1, -2);
	...
	//	this._nav_ny = hh("&#x00bb;", 1, 2);
	this._nav_ny = hh("<img id=objynext src='/Public/Js/DateJs/img/ynext.gif'>", 1, 2);
	this._nav_ny.width = 25;
	this._nav_ny.ttip = Calendar._TT["NEXT_YEAR"];

//	this._nav_pm = hh("&#x2039;", 1, -1);
	this._nav_pm = hh("<img id=objmprev src='/Public/Js/DateJs/img/mprev.gif'>", 1, -1);
...
//	this._nav_nm = hh("&#x203a;", 1, 1);
	this._nav_nm = hh("<img id=objmnext src='/Public/Js/DateJs/img/mnext.gif'>", 1, 1);
...
//	this._nav_now.ttip = Calendar._TT["GO_TODAY"];
	...
	if (this.isPopup) {
		...
		var td_close = hh("<img id=objclose src='/Public/Js/DateJs/img/close.gif'>", 1, 200);
		td_close.ttip = Calendar._TT["CLOSE"];
		td_close.align = "right";
		//hh("#<div><img src=\"calendar/close.gif\" onmousedown=\"return;\"></div>", 1, 200).ttip = Calendar._TT["CLOSE"];
	}	
...
/** Customizes the picture path. */
Calendar.prototype.setPicPath = function (str) {
	this.picpath = str;
};
/**
...
Calendar.prototype.parseDate = function (str, fmt) {
	...
	//add by zhangpeng,对于非法字符输入，显示当前时间
